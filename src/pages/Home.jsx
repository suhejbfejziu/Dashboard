...
export default function Home() {
  ...
  return (
      ...
      <div className="items-center w-full px-5 py-12 mx-auto lg:px-16 max-w-7xl md:px-12">
        <div className="max-w-3xl mx-auto text-center">
          <div>
            ...
            <Balancer className="mt-8 text-3xl font-extrabold tracking-tight text-white lg:text-6xl">
              The Dashboard features your audience will love
            </Balancer>
            <Balancer className="max-w-xl mx-auto mt-8 text-base lg:text-xl text-slate-300">
    ...
    <div className="items-center w-full mx-auto max-w-7xl">
      <div>
        <div className="max-w-2xl">
          <Balancer className="text-2xl font-medium tracking-tight text-black sm:text-4xl">
            Effortlessly Manage Your Online Presence with Our User-Friendly Platform
          </Balancer>
          <Balancer className="max-w-2xl mt-4 text-lg tracking-tight text-gray-600">
  ...
  <div className="items-center w-full mx-auto max-w-7xl">
    <div className="text-center">
      <h1 className="text-lg font-medium leading-6 text-black uppercase">
